...
function modal(triggetSelector, modalSelector, modalTimerId) {
  ...
  const showModelByScrol = () => {
    if (window.scrollY + document.documentElement.clientHeight + 2 >= document.documentElement.scrollHeight) {
      openModal(modalSelector, modalTimerId);
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, ativeClass) {
